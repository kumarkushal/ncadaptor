...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "ncadaptor";
    private final String namespace = "urn:opendaylight:params:xml:ns:yang:ncadaptor";
    private final String revision = "2015-01-05";
    private final String resourcePath = "/META-INF/yang/ncadaptor.yang";
