...
[uninstalled] [3.0.2 ] wrapper           standard-3.0.2      Provide OS integration
[uninstalled] [3.0.2 ] obr               standard-3.0.2      Provide OSGi Bundle Repository (OBR) support
[uninstalled] [3.0.2 ] config            standard-3.0.2      Provide OSGi ConfigAdmin support
[uninstalled] [3.0.2 ] region            standard-3.0.2      Provide Region commands
[uninstalled] [7.5.4.v20111024] jetty             standard-3.0.2      Provide Jetty engine support
[uninstalled] [3.0.2 ] http              standard-3.0.2      Implementation of the OSGI HTTP Service
[uninstalled] [3.0.2 ] http-whiteboard   standard-3.0.2      Provide HTTP Whiteboard pattern support
[uninstalled] [3.0.2 ] war               standard-3.0.2      Turn Karaf as a full WebContainer
[uninstalled] [3.0.2 ] deployers         standard-3.0.2      Provide Karaf deployer
[uninstalled] [3.0.2 ] kar               standard-3.0.2      Provide KAR (KARaf archive) support
[uninstalled] [3.0.2 ] webconsole-base   standard-3.0.2      Base support of the Karaf WebConsole
[uninstalled] [3.0.2 ] webconsole        standard-3.0.2      Karaf WebConsole for administration and monitoring
[uninstalled] [3.0.2 ] ssh               standard-3.0.2      Provide a SSHd server on Karaf
...
Maven builds the web application, web-3.0.2.war, and
